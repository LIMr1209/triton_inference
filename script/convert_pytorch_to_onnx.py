...
def parse_args():
    ...
    parser.add_argument('--dynamic_axes', help='dynamic batch input or output',
                        default='True')
    parser.add_argument('--keep_initializers_as_inputs',
                        help='If True, all the initializers (typically corresponding to parameters) in the exported graph will also be added as inputs to the graph. If False, then initializers are not added as inputs to the graph, and only the non-parameter inputs are added as inputs.',
                        default='True')
    parser.add_argument('--export_params',
                        help='If specified, all parameters will be exported. Set this to False if you want to export an untrained model.',
                        default='True')
